...
const EditProduct = () => {
  ...
  return (
    ...
    <div className="flex flex-col space-y-2">
      <h1 className="text-2xl text-gray-600">Edição dos Produtos</h1>
    </div>
    <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-10 mt-6">
      ...
      <div className="flex flex-col space-y-4">
        ...
        />
        <div className="mt-8">
          <button type="submit" className="w-full py-3 bg-primary text-white ring-red-400 focus:outline-none focus:ring-4 mt-6 rounded-lg transition duration-300">Edição</button>
        </div>
      </div>
    </form>
  </section>
